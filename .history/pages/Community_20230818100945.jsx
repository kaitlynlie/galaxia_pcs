...
const Community = () => (
  <div className='bg-primary-black overflow-hidden'>
    ...
    <div className='relative'>
      ...
      />
      <div className={`w-full ${styles.xPaddings} md:px-[100px] mt-20 items-center flex-col flex justify-between relative mb-20`}>
          <TypingText title='WHO WE ARE' textStyles='text-center mt-20' />
