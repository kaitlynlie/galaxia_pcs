...
const Program = () => {
  return (
    <section className={`${styles.xPaddings} relative z-10 py-8 flex flex-col justify-center items-center mt-20 mb-20`}>
      <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex-col flex justify-center`}>
        ...
        <div
          className="flex justify-center items-center flex-col mt-20 max-[549px]:px-0 px-20 relative">
            <img
                src='/creator.jpg'
                alt='creator'
            />
            <div className={'max-[775px]:px-0 px-16 w-full relative mt-10'}>
                <TypingText title="Process" />
                <TitleText title={<>HOW IT WORKS</>} />
                <div className="mt-[31px] flex flex-wrap items-center justify-start gap-[24px]">
