...
const PickPC = () => {
  ...
  return (
    <section className={`${styles.xPaddings} flex justify-center items-center mt-20 mb-40`}>
        <div className="flex flex-col p-10">
            ...
            <div className="min-[1192px]:flex flex-none max-[1192px]:flex-col justify-between items-center gap-40">
              ...
              <div className="justify-center items-center flex">
                <img src='/pcbg.png' className="absolute z-0 top-[600px] left-[250px]" />
              </div>

            {active === "First" &&
            <div className="justify-center items-center flex">
            <img src="/pc3.png" className="z-10 absolute max-[1192px]:mb-20 max-[1192px]:mt-20 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" />
            </div>
            }
            ...
            <div className="justify-center items-center flex"><img src="/pc2.png" className="z-1 max-[1192px]:mb-20 max-[1192px]:mt-20 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" /></div>}
            {active === "Second" &&     
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-col items-center justify-between">
            ...
            {active === "Third" && <div className="justify-center items-center flex"><img src="/pc1.png" className="z-1 max-[1192px]:mb-20 max-[1192px]:mt-20 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" /></div>}
            {active === "Third" &&     
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-col items-center justify-between">
