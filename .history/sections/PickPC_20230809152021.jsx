  ...
  return (
    <section className={`${styles.xPaddings} flex justify-center items-center mt-20 mb-20`}>
        <div className="flex flex-col bg-[#323f5d] p-10">
            ...
            {active === "First" &&     
            <div className="flex items-center justify-center flex-col border p-2 bg-white">      
                <div className="flex flex-col items-center justify-between">
                    <p className="text-black font-bold text-[16px]">$1,099.99 USD</p>
                    <p className="text-black font-bold line-through text-[14px]">$1,299.99 USD</p>
                </div>
                
                <div className="flex flex-col justify-center items-center">
                    <div className="flex flex-col justify-center items-center font-bold">
                        <p className="text-[16px] mt-[20px] text-black">Earth Core e2-1023</p>
                        <p className="text-[16px] mt-[20px] text-black">KForce MTX2390 Ti 12GB</p>
                        <p className="text-[16px] mt-[20px] text-black">RGB 32GB DDR5 CL38</p>
                        <p className="text-[16px] mt-[20px] text-blacks">NSI Z790 Wifi DDR5</p>
                    </div>
                    <Button />
                </div>
            </div>}
