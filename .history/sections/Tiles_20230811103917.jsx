...
const Tiles = () => {
  return (
    ...
    <div className={`${styles.innerWidth} mb-0 items-center flex justify-center`}>
      <div className='justify-between justify-center flex gap-10 mt-10 flex-row max-[1009px]:flex-col max-[1539px]:gap-2'>
