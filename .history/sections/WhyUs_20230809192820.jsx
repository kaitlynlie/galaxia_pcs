...
const GetStarted = () => (
  <section className={`${styles.paddings} relative z-10 flex justify-center items-center max-[1280px]`}>
    <div className={`${styles.innerWidth} mx-auto flex flex-col justify-between items-center`}>
        ...
        <div
          className="flex justify-around gap-[20px] w-[100%]">
            <div className="flex flex-col max-w-0rem">
