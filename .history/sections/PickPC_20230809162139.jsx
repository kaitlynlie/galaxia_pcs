  ...
  return (
    <section className={`${styles.xPaddings} flex justify-center items-center mt-20 mb-20`}>
        <div className="flex flex-col p-10">
            ...
            <div className="min-[1267px]:flex flex-none max-[1267px]:flex-col justify-between items-center gap-20">
            ...
            {active === "Fourth" && <div className="justify-center items-center flex"><img src="/pc4.png" className="max-[1267px]:mb-20 max-[1267px]:mt-20 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" /></div>}
            {active === "Fourth" &&     
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-col items-center justify-between">
            ...
            {active === "Fifth" && <div className="justify-center items-center flex"><img src="/pc5.png" className="max-[1267px]:mb-20 max-[1267px]:mt-20 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" /></div>}
            {active === "Fifth" &&     
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-col items-center justify-between">
            ...
            {active === "Sixth" && <div className="justify-center items-center flex"><img src="/pc6.png" className="max-[1267px]:mb-20 max-[1267px]:mt-20 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" /></div>}
            {active === "Sixth" &&     
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-col items-center justify-between">
