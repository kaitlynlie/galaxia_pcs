...
const Tiles = () => {
  return (
    <section className={`${styles.xPaddings} relative z-10 py-20 max-[1191px]:flex-none flex justify-center items-center`}>
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center max-[1191px]:flex flex-none justify-center`}>
