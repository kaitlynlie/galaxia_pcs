...
const PickPC = () => {
    ...
    useEffect(() => {
      ...
      const images = Array.from(document.querySelectorAll('.your-image-class'));
    ...
    <section className={`${styles.xPaddings} flex justify-center items-center mt-20 mb-40`}>
        <div className="flex flex-col p-10">
            ...
            <div className="justify-center items-center flex">
              <div class="relative">
                <img src="./pc3.png" alt="Image" loading="lazy" class="max-[1192px]:mb-20 max-[1192px]:mt-20 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300 opacity-0 transition-opacity duration-300 ease-in-out" />
