...
const Testimonials = () => {
  return (
    <section className={`${styles.xPaddings} relative z-10 py-20 flex flex-col justify-center items-center bg-white`}>
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex-col flex justify-center`}>
      ...
      <div className='justify-between flex-row flex gap-10 mt-10'>
        <div className='bg-white shadow-lg w-[456px] h-[372px]'>
