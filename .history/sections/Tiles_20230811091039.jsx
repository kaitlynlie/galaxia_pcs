...
const Tiles = () => {
  return (
    ...
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex justify-center flex-col max-[1000px]:flex-row`}>
      <div className='justify-between justify-center flex-col max-[1000px]:flex-row flex gap-20 max-[1241px]:gap-2 mt-10'>

        <div className='bg-white shadow-xl shadow-[#25618B] justify-between flex items-center pointer w-[240px] h-[160px]'>
