    ...
    <section className={`${styles.xPaddings} flex justify-center items-center mt-20`}>
        <div className="flex flex-col bg-[#323f5d] p-10">
            ...
            <div className="flex max-[976px]:flex-col justify-between items-center gap-1">
                ...
                <button
                  className={`${coloringButton("btn1")} text-2xl font-titles font-semibold border-none cursor-pointer py-4 bg-gray-300 transition-colors duration-200 text-left hover:bg-[#25618B] hover:text-white`}
                  onClick={() => {
                    setActive("First");
                    btnID("btn1");
                  }}
