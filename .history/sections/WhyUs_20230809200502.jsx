        ...
        <div
          className="flex justify-evenly">
            <div className="flex flex-col">
              ...
              <p className="text-white mt-10 max-w-100">Here at GALAXIA, our main goal is to provide the best service we can while having fun and making computers with high performance. We value the highest quality components, as well has hard work, kindness, and respect.</p>
            </div>
