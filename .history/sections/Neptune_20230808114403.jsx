  ...
  <section className={`${styles.paddings}`} id='pc'>
    <motion.div 
      ...
      className={`${styles.innerWidth} mx-auto flex flex-col`}>
        ...
        <TitleText title={"Shop Neptune's Collection"} textStyles='lg:text-start text-center items-center justify-center'/>
        <div className="mt-[50px] flex max-[1162px]:flex-row flex-col justify-center items-center">
