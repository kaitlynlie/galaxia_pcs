...
const Testimonials = () => {
  return (
    <section className={`${styles.xPaddings} relative z-10 py-20 flex flex-col justify-center items-center bg-[url('/testimonials.png')]`}>
      <div class="absolute inset-0 bg-[url('/testimonials.jpeg')] bg-opacity-50">
    </div>
