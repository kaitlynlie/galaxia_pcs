...
const Tiles = () => {
  return (
    <section className={`${styles.xPaddings} relative z-10 py-20 flex justify-center items-center bg-[url('/tiles.png')]`}>
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center min-[1191px]:flex flex-none justify-center`}>
      <div className='justify-between justify-center flex gap-10 mt-10 flex-row max-[1191px]:flex-col max-[1539px]:gap-2'>
        ...
        <div className='bg-white shadow-xl shadow-[#25618B] justify-between flex items-center cursor-pointer w-[100%] h-[160px]'>
