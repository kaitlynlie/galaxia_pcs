...
const PickPC = () => {
  ...
  return (
    <section className={`${styles.xPaddings} ${styles.innerWidth} flex justify-center items-center mt-20`}>
        <div className="flex justify-between items-center flex-col bg-black">
            ...
            <div className="flex justify-between">
                ...
                <button
                  className={`${coloringButton("btn1")} text-2xl font-titles font-semibold border-none cursor-pointer px-6 py-4 bg-gray-300 transition-colors duration-200 text-left hover:bg-orange-500 hover:text-white`}
                  onClick={() => {
                    setActive("First");
                    btnID("btn1");
                  }}
                ...
                <button
                  className={`${coloringButton("btn2")} text-2xl font-titles font-semibold border-none cursor-pointer px-6 py-4 bg-gray-300 transition-colors duration-200 text-left hover:bg-orange-500 hover:text-white`}
                  id="btn2"
                  onClick={() => {
                    setActive("Second");
                    btnID("btn2");
                ...
                <button
                  className={`${coloringButton("btn3")} text-2xl font-titles font-semibold border-none cursor-pointer px-6 py-4 bg-gray-300 transition-colors duration-200 text-left hover:bg-orange-500 hover:text-white`}
                  id="btn3"
                  onClick={() => {
                    setActive("Third");
                    btnID("btn3");
                ...
                <button
                  className={`${coloringButton("btn4")} text-2xl font-titles font-semibold border-none cursor-pointer px-6 py-4 bg-gray-300 transition-colors duration-200 text-left hover:bg-orange-500 hover:text-white`}
                  id="btn4"
                  onClick={() => {
                    setActive("Fourth");
                    btnID("btn4");
                ...
                <button
                  className={`${coloringButton("btn5")} text-2xl font-titles font-semibold border-none cursor-pointer px-6 py-4 bg-gray-300 transition-colors duration-200 text-left hover:bg-orange-500 hover:text-white`}
                  id="btn5"
                  onClick={() => {
                    setActive("Fifth");
                    btnID("btn5");
                ...
                <button
                  className={`${coloringButton("btn6")} text-2xl font-titles font-semibold border-none cursor-pointer px-6 py-4 bg-gray-300 transition-colors duration-200 text-left hover:bg-orange-500 hover:text-white`}
                  id="btn6"
                  onClick={() => {
                    setActive("Sixth");
                    btnID("btn6");
