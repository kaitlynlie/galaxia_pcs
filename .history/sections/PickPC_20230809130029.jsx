        ...
        <div className="flex flex-col bg-[#323f5d] p-10">
            ...
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-row items-center justify-between">
                    ...
                    <p className="text-white line-through text-[14px] ml-1">$1,299.99 USD</p>
                </div>
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <img
                        src="/core.svg"
                        alt="core"
                        className="w-[37px] h-[37px] mt-[20px] justify-center items-center" />
                        <p className="text-[18px] mt-[20px] ml-[19px] text-white">Earth Core e2-1023</p>
                    </div>
                    <div className="flex flex-row justify-center items-center">
                    <img
                        src="/card.svg"
                        alt="card"
                        className="w-[37px] h-[37px] mt-[20px] justify-start items-center" />
                        <p className="text-[18px] mt-[20px] ml-[19px] text-white">KForce MTX 2390 Ti 12GB</p>
                    </div>
