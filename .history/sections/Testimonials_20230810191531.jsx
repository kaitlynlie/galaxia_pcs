...
const Testimonials = () => {
  return (
    <section className={`${styles.xPaddings} relative z-10 py-20 flex flex-col justify-between items-center`}>
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex-col flex justify-center`}>
      ...
      <div className='justify-between flex-row flex gap-20 mt-10'>
        <div className='bg-white shadow-lg shadow-[#25618B]'>
