        ...
        <div className="flex flex-col bg-[#323f5d] p-10">
            ...
            <div className="min-[976px]:flex flex-none max-[976px]:flex-col justify-between items-center gap-1">
              <div className="flex-col flex gap-2">
                <button
                  className={`${coloringButton("btn1")} text-2xl font-titles font-semibold border-none cursor-pointer px-6 py-4 bg-[#323f5d] transition-colors duration-200 text-left hover:bg-[#25618B] hover:text-black text-white`}
                  onClick={() => {
                    setActive("First");
                    btnID("btn1");
                  }}
