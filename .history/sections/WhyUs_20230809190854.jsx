        ...
        <motion.div
          ...
          className="flex-[0.75] flex justify-between flex-row">
            <div className="flex flex-col">
              ...
              <p>Here at GALAXIA, our main goal is to provide the best service we can while having fun and making computers with high performance. We value the highest quality components, as well has hard work, kindness, and respect.</p>
            </div>
