...
const People = () => (
    <section className={`${styles.xPaddings} relative z-10 py-8 flex flex-col justify-center items-center mt-10 gap-[10px]`}>
    ...
    <div className={`${styles.innerWidth} ${styles.xPaddings} md:px-[100px] mb-0 items-center flex-row max-[1234px]:flex-col flex flex-start justify-between mt-20`}>     
      <img
        src="/process.png"
        alt="process"
