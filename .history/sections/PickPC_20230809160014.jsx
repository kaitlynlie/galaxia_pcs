    ...
    <section className={`px-40 flex-1 justify-center items-center mt-20 mb-20`}>
        <div className="flex flex-col bg-[#323f5d] p-20">
            <div className="text-center text-white mb-20 font-bold">
                ...
                <span className="font-extrabold text-white sm:text-[32px] text-[20px]">Choose from a variety of our amazing PCs <br className="max-[1267px]:block hidden"/> for your next adventure</span>
            </div>
            ...
            <img src="/pc3.png" className="max-[1267px]:mb-10 max-[1267px]:mt-10 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" />
            </div>
            }
            ...
            <div className="justify-center items-center flex"><img src="/pc2.png" className="max-[1267px]:mb-10 max-[1267px]:mt-10 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" /></div>}
            {active === "Second" &&     
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-col items-center justify-between">
            ...
            {active === "Third" && <div className="justify-center items-center flex"><img src="/pc1.png" className="max-[1267px]:mb-10 max-[1267px]:mt-10 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300" /></div>}
            {active === "Third" &&     
            <div className="flex items-center justify-center flex-col">      
                <div className="flex flex-col items-center justify-between">
