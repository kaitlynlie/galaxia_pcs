...
const Tiles = () => {
  return (
    ...
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center min-[1191px]:flex flex-none justify-center`}>
      <div className='justify-between justify-center flex gap-10 mt-10 flex-row max-[1191px]:flex-col max-[1539px]:gap-2'>

        <div className='bg-secondary-blue shadow-xl shadow-[#25618B] justify-between flex items-center cursor-pointer w-[100%] h-[160px]'>
            <p className='mb-20 text-black font-medium text-2xl ml-4'>Gaming PCs</p>
            <img src='./pc5.png' className='w-[100px] h-[100px] mr-4 mt-10'/>
        </div>

        <div className='bg-secondary-blue shadow-xl shadow-[#25618B] flex items-center justify-between cursor-pointer w-[100%] h-[160px]'>
        ...
        <div className='bg-white shadow-xl shadow-[#25618B] flex items-center justify-between cursor-pointer w-[100%] h-[160px]'>
