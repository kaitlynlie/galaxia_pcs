...
const Hero = () => (
  <section className={`${styles.topPaddings} ${styles.xPaddings} flex flex-row items-center justify-center`}>
    <motion.div
      variants={fadeIn('up', 'tween', 0.2, 1)}
      initial="hidden"
      whileInView="show"
      viewport={{ once: true, amount: 0.25 }}
      className={`${styles.innerWidth} flex-col relative w-full flex justify-between items-center z-10`}
    >
      <div className="absolute z-0"/>
      <img
        src="/pc1.png"
        alt="pc"
        className="object z-10 sm:w-[357px] sm:h-[420px] w-[281px] h-[336px] relative mt-24"
      />
    </motion.div>
      ...
      <motion.div 
        ...
        whileInView='show'
        viewport={{ once: true, amount: 0.25}}
        className={`${styles.innerWidth} ${styles.xPaddings} md:px-[100px] max-[1000px]:hidden block mb-0 items-center`}>
