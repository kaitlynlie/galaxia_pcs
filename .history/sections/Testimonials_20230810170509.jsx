    ...
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex-col flex justify-center`}>
      ...
      <div className='justify-between flex-row flex gap-10 mt-10'>
        <div className='bg-white shadow-lg w-[456px] h-[372px] shadow-white'>
            <p className='mt-10 text-black font-medium text-2xl mx-10 font-bold'>"Works great, fast, and quiet. Shipped super secure. No problems with it for streaming any game. Very glad with our selection and happy with purpose."</p>
            <div className='flex-row flex'>
                <img src='./people-01.png' className='w-[50px] h-[50px] mx-10 mt-10'/>
                <div className='flex flex-col'>
                    <p className='mt-10 font-bold'>Mustache Man</p>
                    <p>Nereid</p>
                </div>
            </div>
        </div>
