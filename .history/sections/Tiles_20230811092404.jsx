...
const Tiles = () => {
  return (
    <section className={`${styles.xPaddings} relative z-10 py-20  justify-center items-center`}>
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex justify-center`}>
      <div className='justify-between justify-center flex gap-20 mt-10 flex-row max-[1240px]:gap-2 max-[1009px]:flex-col'>
