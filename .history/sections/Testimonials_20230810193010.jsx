...
const Testimonials = () => {
  return (
    ...
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex-col flex justify-center`}>
      ...
      <div className='justify-between justify-center flex-row flex gap-20 mt-10'>
        {/* <div className='bg-white shadow-lg shadow-[#25618B] flex-1'>
        ...
        <div className='bg-white shadow-lg shadow-[#25618B] flex-1'>
            <p className='mt-10 text-black font-medium text-2xl mx-10'>"Been using it for a few months now. PC looks great and runs every game I play very nicely. Customer service was top notch, had great communication all the ways."</p>
                <div className='flex-row flex mt-2'>
                 <img src='./people-01.png' className='w-[50px] h-[50px] mx-10 mt-10'/>
