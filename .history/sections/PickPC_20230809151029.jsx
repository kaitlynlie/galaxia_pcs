  ...
  return (
    <section className={`${styles.xPaddings} flex justify-center items-center mt-20`}>
        <div className="flex flex-col bg-[#323f5d] p-10">
            ...
            {active === "First" && <img src="/pc3.png" className=" max-[976px]:mb-10 max-[976px]:mt-10 w-[281px] h-[336px] hover:scale-110 hover:brightness-75 transition-all duration-300 items-center" />}
            {active === "First" &&     
