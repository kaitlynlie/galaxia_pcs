    ...
    <section className={`${styles.xPaddings} flex justify-center items-center mt-20 mb-20`}>
        <div className="flex flex-col p-10">
            <div className="text-center text-white mb-20 font-bold">
                ...
                <p>From our range of prices, you can select the one that best suits you. Fast, reliable, and good looking, our PCs are ready to take you to the next level.</p>
            </div>
