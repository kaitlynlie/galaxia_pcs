...
const Tiles = () => {
  return (
    ...
    <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex justify-center`}>
      <div className='justify-between justify-center flex gap-20 max-[1241px]:gap-2 mt-10'>
        ...
        <div className='bg-white shadow-xl shadow-[#25618B] flex items-center flex-col justify-between pointer w-[240px] h-[160px]'>
