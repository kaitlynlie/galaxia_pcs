...
const People = () => (
    <section className={`${styles.xPaddings} relative z-10 py-8 flex flex-row justify-center items-center mt-10`}>
      ...
      <div className={`${styles.innerWidth} md:px-[100px] mb-0 items-center flex-col flex justify-between`}>
        ...
        <img
          src="/process.png"
          alt="process"
          className="z-10 relative w-[90%] h-[90%] mt-20"
        />
          {/* <img
            src="/team.png"
            alt="team"
    ...
    <div className={`${styles.innerWidth} ${styles.xPaddings} md:px-[100px] mb-0 items-center flex-col flex justify-between mt-20`}>     
      <img
        src="/team.png"
        alt="team"
        className="z-10 relative w-[90%] h-[90%] mt-20 max-[1234px]:hidden"
      />
