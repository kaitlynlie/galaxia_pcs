...
const Navbar = () => {
  ...
  >
    <img
          src='./stars.png'
          alt='stars'
          className="z-0 absolute w-screen h-screen object-cover object-center"
    />
    <div className={`${styles.innerWidth} mx-auto flex justify-between gap-8 inline-block`}>
      <div className="flex flex-row gap-4 z-10">
        <img
          ...
          alt='logo'
          />
          <Link onClick={openNav} to="/"><motion.h1 variants={textVariant(1.1)} className="flex text-white font-bold text-[24px] z-10">
            <a>GALAXIA</a>
          </motion.h1></Link>
      </div>
