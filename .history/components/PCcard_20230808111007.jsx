...
const PCcard = ({ imgUrl, title, price, xprice}) => (
  <motion.div
    ...
    className={`flex flex-center flex-col items-center justify-center transition-[flex] duration-[0.7s] ease-out-flex cursor-pointer lg:mt-0 mt-12 text-white border-2 border-gray-500`}
  >
    <img 
      src={imgUrl}
      alt={title}
